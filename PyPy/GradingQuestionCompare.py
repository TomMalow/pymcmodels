...
print "Bias:"
plot_bias(mock_data,[("Ext. Gibbs",mock_gibbs_ext_result),("MH",mock_MH_result)],nth=4)
print "Handin scores:"
plot_handins(mock_data,[("Ext. Gibbs",mock_gibbs_ext_result),("MH",mock_MH_result)],nth=4)